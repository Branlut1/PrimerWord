...
function kadence_importer_old_php_admin_error_notice() {
	$message = __( 'The Kadence Importer plugin requires at least PHP 5.4 to run properly. Please contact your hosting company and ask them to update the PHP version of your site to at least PHP 5.4. We strongly encourage you to update to 7.3', 'kadence-importer' );
