...
if (!function_exists('ere_get_taxonomy_by_post_id')) {
    function ere_get_taxonomy_by_post_id($post_id, $taxonomy_name, $is_target_by_name = false, $show_default_none = true, $multiple = false)
    {
        ...
        $target_by_name = $multiple ? array() : '';
        $target_by_id = $multiple ? array() : 0;
