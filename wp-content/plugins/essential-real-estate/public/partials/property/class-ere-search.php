    ...
    class ERE_Search
    {
        ...
        public function ere_ajax_change_price_on_status_change()
        {
            ...
            if (!empty($price_is_slider)&& $price_is_slider=='true') {
                $min_price = apply_filters('ere_price_slider_min_default',0) ;
                $max_price = apply_filters('ere_price_slider_max_default',1000);
                ...
                if ($property_price_slider_search_field != '') {
	                if ($request_status == '') {
		                ...
		                foreach ($property_price_slider_search_field as $data) {
		                	$price_slider_min = isset($data['property_price_slider_min']) ? $data['property_price_slider_min'] : -1;
		                	$price_slider_max = isset($data['property_price_slider_max']) ? $data['property_price_slider_max'] : -1;

		                	if (($min_price_all == -1) || (($price_slider_min !== -1) && ($price_slider_min < $min_price_all))) {
				                $min_price_all = $price_slider_min;
			                }

		                	if (($max_price_all == -1) ||
			                    (($price_slider_max !== -1) && ($price_slider_max > $max_price_all)) ) {
				                $max_price_all = $price_slider_max;
			                }
		                }
            ...
            {
                $property_price_dropdown_min= apply_filters('ere_price_dropdown_min_default','0,100,300,500,700,900,1100,1300,1500,1700,1900') ;
                $property_price_dropdown_max= apply_filters('ere_price_dropdown_max_default','200,400,600,800,1000,1200,1400,1600,1800,2000') ;
